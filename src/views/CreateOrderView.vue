<template>
  <div class="card-form">
    ...
    <div class="card-form__inner">
      ...
      <div class="card-input">
        <label for="cardName" class="card-input__label">信用卡持有人</label>
        <input
          type="text"
          id="cardName"
          class="card-input__input"
      ...
      <div class="card-form__row">
        <div class="card-form__col">
          <div class="card-form__group">
            <label for="cardMonth" class="card-input__label">有效日期</label>
            <select
        ...
        <div class="card-form__col -cvv">
          <div class="card-input">
            <label for="cardCvv" class="card-input__label">檢查碼</label>
            <input
              type="text"
              class="card-input__input"
              id="cardCvv"
      ...
      <button class="card-form__button" @click="payTheOrder()">送出</button>
    </div>
  </div>
</template>
