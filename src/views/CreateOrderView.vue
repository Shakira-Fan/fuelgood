    ...
    <div id="Checkout" class="inline">
      ...
      <form>
        ...
        <div class="form-group card-style">
          <label or="NameOnCard">持卡人姓名</label>
          <input
            id="NameOnCard"
            class="form-control"
            type="text"
        ...
        <div class="expiry-date-group form-group card-style">
          <label for="ExpiryDate">信用卡有效期限</label>
          <input
            id="ExpiryDate"
            class="form-control"
            type="text"
        ...
        <div class="security-code-group form-group">
          <label for="SecurityCode">信用卡檢核碼</label>
          <div class="input-container">
            <input id="SecurityCode" class="form-control" type="text" />
            <i id="cvc" class="fa fa-question-circle" @click="touch()"></i>
          </div>
          <div class="cvc-preview-container two-card" v-show="isInfoShow">
        ...
        >
          ...
          <span class="align-middle">Pay ${{ paytotal }}</span>
        </button>
      </form>
    </div>
  </div>
